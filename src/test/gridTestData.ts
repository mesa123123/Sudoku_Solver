...
export let shortRowAndShortLengthArray: Array<Array<number>> = [
  [0, 0, 0, 2, 6, 0, 7, 0, 1],
  [6, 8, 0, 0, 7, 0, 0, 9, 0],
  [1, 9, 0, 0, 0, 4, 5, 0, 0],
  [8, 2, 0, 1, 0, 0, 0, 4, 0],
...
// This is just so I don't have to keep track of what cells I've messed with so I created this type, Goddam this is bloody overkill...
export type WrongArray = {
  startingState: Array<Array<number>>,
  coordinates: Array<number>
}

export let highNumberArray:WrongArray  = {
  startingState: [ 
  [0, 0, 0, 2, 6, 0, 8, 0, 1],
  [6, 8, 0, 0, 7, 0, 0, 9, 0],
  [1, 9, 0, 0, 0, 4, 5, 0, 0],
...
export let negativeNumberArray: WrongArray = {
  startingState: [
  [0, 0, 0, 2, 6, 0, -8, 0, 1],
  [6, 8, 0, 0, 7, 0, 0, 9, 0],
  [1, 9, 0, 0, 0, 4, 5, 0, 0],
...
export function wrongNumberErrorMessage(i: number, j: number): string {
  return (
